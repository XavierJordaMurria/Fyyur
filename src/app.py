...
def create_show_submission():
  ...
  try:
    ...
    venue:Venue = Venue.query.filter_by(id=venue_id).options(load_only(*venue_fields)).first()

    artitst_fields = ["id", "name", "image_link"]
    artist:Artist = Artist.query.filter_by(id=artist_id).options(load_only(*artitst_fields)).first()
